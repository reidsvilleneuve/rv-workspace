...
alias pd="pushd"
alias gr="git grep"
alias fin="git ls-files | grep -i"
alias tw="cut -c -`tput cols`"
alias gr-nat="grep -R --exclude-dir=node_modules --exclude '*.min.*'"
alias fin-nat="find . -not -path './node_modules/*' -iname"
